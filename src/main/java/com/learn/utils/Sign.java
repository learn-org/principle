 ...
 * @author: lxj
 * @Date: 2021/5/14
 * @Description: COS JSON API SDK 签名
 */
public class Sign {
	 ...
	 * @throws Exception
	 */
	private static String appSignatureBase(Credentials cred, String bucketName, String cosPath, long expired, boolean uploadFlag) throws Exception {
